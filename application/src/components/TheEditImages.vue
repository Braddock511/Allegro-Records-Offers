<template>
    <div class="data" v-if="!loading">
        ...
        <span id="buttons" style="width: 50%;">
    ...
    export default {
        ...
        methods:{
            ...
            async editImages(){
                ...
                await axios.post('http://127.0.0.1:8000/allegro-edit-image', {offerID: this.allegroData.data.offers[this.offerIndex].id, images: newImages})
                // Next images
                this.next()
            },  
            async next(){
