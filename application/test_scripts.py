...
class Test(unittest.TestCase):
    ...
    def test_search_image_data(self):
        ...
        result = search_data(data, Test.credentials['api_discogs_token'], type_record, image_data)
    ...
    def test_search_vinyl_data(self):
        ...
        result = search_data(data, Test.credentials[''], type_record, image_data)
    ...
    def test_preprocess_data_vinyl(self):
        ...
        self.assertEqual(result[0]['country'], "Germany")
        self.assertEqual(result[0]['year'], "1972")
        self.assertEqual(result[0]['label'], "Atlantic | ATL40417")
        self.assertEqual(result[1]['country'], "US")
        self.assertEqual(result[1]['year'], "1960")
        self.assertEqual(result[1]['label'], "Cook")
    ...
    def test_get_vinyl(self):
        ...
        result = get_vinyl(query, Test.credentials['api_discogs_token'])
    ...
    def test_get_cd(self):
        ...
        result = get_cd(barcode, Test.credentials['api_discogs_token'])
    ...
    def test_get_price(self):
        ...
        result = get_price(id, Test.credentials['api_discogs_token'])
    ...
    def test_get_tracklist(self):
        ...
        result = get_tracklist(id, Test.credentials['api_discogs_token'])
    ...
    def test_annual_sale_barplot(self):
        data = [{'name': '', 'productSet': [{'product': {'id': '', 'publication': {'status': ''}, 'parameters': [{'id': '', 'name': '', 'values': [''], 'valuesIds': None, 'rangeValue': None}, {'id': '', 'name': '', 'values': [''], 'valuesIds': None, 'rangeValue': None}, {'id': '', 'name': '', 'values': [''], 'valuesIds': None, 'rangeValue': None}, {'id': '', 'name': '', 'values': [''], 'valuesIds': [''], 'rangeValue': None}, {'id': '', 'name': 'Wykonawca', 'values': [''], 'valuesIds': None, 'rangeValue': None}, {'id': '', 'name': '', 'values': [''], 'valuesIds': None, 'rangeValue': None}, {'id': '', 'name': '', 'values': [''], 'valuesIds': [''], 'rangeValue': None}, {'id': '', 'name': '', 'values': [''], 'valuesIds': None, 'rangeValue': None}, {'id': '', 'name': 'Wytwórnia', 'values': [''], 'valuesIds': [''], 'rangeValue': None}]}, 'quantity': {'value': 1}}], 'parameters': [{'id': '', 'name': '', 'values': [''], 'valuesIds': [''], 'rangeValue': None}], 'images': [], 'afterSalesServices': {'impliedWarranty': {'id': ''}, 'returnPolicy': {'id': ''}, 'warranty': None}, 'payments': {'invoice': ''}, 'sellingMode': {'format': '', '': {'amount': '', 'currency': ''}, 'startingPrice': None, 'minimalPrice': None}, 'stock': {'available': 1, 'unit': ''}, 'location': {'countryCode': '', 'province': '', 'city': '', 'postCode': ''}, 'delivery': {'shippingRates': {'id': ''}, 'handlingTime': '', 'additionalInfo': '', 'shipmentDate': None}, 'description': {}, 'external': None, 'category': {'id': ''}, 'tax': None, 'sizeTable': None, 'discounts': {'wholesalePriceList': None}, 'contact': None, 'fundraisingCampaign': None, 'messageToSellerSettings': None, 'attachments': [], 'b2b': None, 'additionalServices': None, 'compatibilityList': None, 'id': '', 'language': '', '': {'status': '', 'duration': None, 'endedBy': None, 'endingAt': None, 'startingAt': None, 'republish': False}, 'validation': {'errors': [], 'warnings': [], 'validatedAt': ''}, 'createdAt': '', 'updatedAt': ''}]
        result = create_genres_barplot(Test.credentials, data)
