...
class Test(unittest.TestCase):
    ...
    def test_search_image_data(self):
        ...
        discogs_token = "PhGScwKlhpPNIdWyuoTrVkzlZQZoXzAleAlrOrYW"
        type_record = "Vinyl"
        image_data = True
    ...
    def test_get_vinyl(self):
        ...
        discogs_token = "PhGScwKlhpPNIdWyuoTrVkzlZQZoXzAleAlrOrYW"
        result = get_vinyl(query, discogs_token)
    ...
    def test_get_cd(self):
        barcode = "88985479932"
        discogs_token = "PhGScwKlhpPNIdWyuoTrVkzlZQZoXzAleAlrOrYW"
        result = get_cd(barcode, discogs_token)
    ...
    def test_get_price(self):
        id = "26182769"
        discogs_token = "PhGScwKlhpPNIdWyuoTrVkzlZQZoXzAleAlrOrYW"
        result = get_price(id, discogs_token)
    ...
    def test_get_tracklist(self):
        id = "26182769"
        discogs_token = "PhGScwKlhpPNIdWyuoTrVkzlZQZoXzAleAlrOrYW"
        result = get_tracklist(id, discogs_token)
